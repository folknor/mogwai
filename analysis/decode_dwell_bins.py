...
def main():
    ...
    md = fp["scalar_ranges"]["mean_duration_s"]
    print("fingerprint scalar_ranges.mean_duration_s:", md)
    disp = fp["golden_targets"]["duration_dispersion_index"]
    print("fingerprint golden_targets.duration_dispersion_index:", disp)
