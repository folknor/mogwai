...
fn content(topic: ManTopic) -> &'static str {
    match topic {
        ...
        ManTopic::Architecture => concat!(
            include_str!("../../../reference/architecture.md"),
            "\n",
            include_str!("../../../reference/architecture-runtime.md"),
            "\n",
            include_str!("../../../reference/architecture-accounts.md"),
            "\n",
            include_str!("../../../reference/architecture-delivery.md"),
            "\n",
            include_str!("../../../reference/architecture-generator.md"),
            "\n",
            include_str!("../../../reference/architecture-workspace.md"),
        ),
